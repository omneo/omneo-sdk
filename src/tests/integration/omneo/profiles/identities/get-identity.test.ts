...
describe('Profile Identity get', () => {
  test('SDK can get profile identity.', async () => {
    const payload = {
    ...
    const identityGet = await omneo.profiles.identities.get(testProfileID, identity.handle)
