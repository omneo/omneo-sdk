...
describe('ID Create Profile List Custom Item', () => {
  testWithIDData('ID SDK Create Profile List Custom Item', async ({ IDData }) => {
    const { tokenData } = IDData
    // Create List Definition
    const payload = {
      name: getRandomString('id_sdk_list_definition_name_for_create_list_custom_item'),
      handle: getRandomString('id_sdk_list_definition_handle_for_create_list_custom_item'),
      type: 'gift_registry',
      is_published: true,
      allow_quantity: true,
    ...
    const payload3 = {
      name: getRandomString('id_sdk_list_name_for_create_list_custom_item'),
      description: getRandomString('id_sdk_list_description_for_create_list_custom_item'),
